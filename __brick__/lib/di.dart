...
import 'features/flights/domain/data_sources/flights_data_source_local.dart';
import 'features/flights/domain/data_sources/flights_data_source_remote.dart';
...
void initializeDependencies() {
  ...
  // --- Data Sources ---
  locator.registerLazySingleton<LoginDataSourceInterface>(() => LoginDataSourceLocal(locator()), instanceName: 'LoginDataSourceLocal');
  locator.registerLazySingleton<LoginDataSourceInterface>(() => LoginDataSourceRemote(locator()), instanceName: 'LoginDataSourceRemote');

  locator.registerLazySingleton<FlightsDataSourceInterface>(() => FlightsDataSourceLocal(locator()), instanceName: 'FlightsDataSourceLocal');
  locator.registerLazySingleton<FlightsDataSourceInterface>(() => FlightsDataSourceRemote(locator()), instanceName: 'FlightsDataSourceRemote');
  // --- Repositories ---
